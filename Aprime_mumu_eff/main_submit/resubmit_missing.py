...
def submit_job(config_file, config_dir):
    ...
    #Output files
    tag = "Aprime_Muons_Scan_z200_600_18_04_2022" ####### FIRST PARAMETER
    ...
    macro_command = "'/tmp/$CONDOR_JOB_ID/RecoE1039Sim.C(10000, 1, 0, -300, true, true, false, {}, {}, {}, {})'"\
    ...
    for filename in os.listdir(config_dir):
        if filename.startswith("Brem"):
            ...
            if not exists(path_to_file):
                print("Resubmitting ... ", config_file)
