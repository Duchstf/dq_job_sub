...
gfal-copy gsiftp://se01.cmsaf.mit.edu:2811//mitgroups/DarkQuest/dhoang/Aprime_Muons_Scan_z200_600_18_04_2022/Brem_0.250000_z200_600_eps_-4_DST.root .

echo "Copying Data DST file"
gfal-copy gsiftp://se01.cmsaf.mit.edu:2811//mitgroups/DarkQuest/0150/embedding_data.root .
...
cp Brem_0.250000_z200_600_eps_-4_DST.root /tmp/$CONDOR_JOB_ID
cp Brem_0.250000_z200_600_eps_-4_singularity.sh /tmp/$CONDOR_JOB_ID
...
singularity exec -B /cvmfs -B /usr -B /etc new-sif.sif bash /tmp/$CONDOR_JOB_ID/Brem_0.250000_z200_600_eps_-4_singularity.sh

echo 'I ran, now ls tmp'
ls -lth /tmp/$CONDOR_JOB_ID/
gfal-copy -f file:///tmp/$CONDOR_JOB_ID/output.root gsiftp://se01.cmsaf.mit.edu:2811//mitgroups/DarkQuest/dhoang/Data_EB_Aprime_Muons_Scan_z200_600_17_05_2022/Brem_0.250000_z200_600_eps_-4.root

rm Brem_0.250000_z200_600_eps_-4_DST.root
rm new-sif.sif
